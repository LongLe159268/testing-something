...
test.describe("Abc", async () => {
    ...
    test.beforeAll(async () => {
        ...
        xpath= {
            ...
            abc: 'xpath=/html/body/div/div/div[2]/aside/div[1]/ul/li[2]/span',
    ...
    test("TC_01: fgh", async ({page}) => {
        
        //await page.getByRole("link", {name: "Kỳ thi"}).click();

        //await page.waitForTimeout(500); // đợi 500ms
        
        // await page.locator("//input[@id = 'not_started_state']").click({force: true});
        
        await page.getByText("Danh mục chung").click();

        await page.getByRole('link', {name: "Bậc thợ"}).click();

        await page.locator('//button[@id = "btn_add_worker_level"]').click();

        await page.locator("//div[@id = 'color_picker_worker_level']").click();



        // await page.evaluate(() => {
        // const input = document.querySelector('input#hiddenInput');
        // input?.click();
        ...
        //     // test
        //    // /html/body/div[1]/div/div[2]/aside/div[1]/ul/li[2]
        //    // /html/body/div/div/div[2]/aside/div[1]/ul/li[2]/span
        //     //await page.locator(xpath.abc).click();
        //     //await page.waitForTimeout(500); // đợi 500ms
        // });
        ...
        //     // await page.locator("//input[@id = 'pending_state']").click();
        //     // await page.waitForTimeout(500); // đợi 500ms
        // });
